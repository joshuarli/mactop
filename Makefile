...
BENCH_PROCESS_COUNT ?= 8
BENCH_COORDINATOR_HISTORY ?= 0
...
bench:
	swift build -c release --product mactopBench
	BENCH_SECONDS=$(BENCH_SECONDS) BENCH_INTERVAL=$(BENCH_INTERVAL) BENCH_WARMUP_TICKS=$(BENCH_WARMUP_TICKS) BENCH_PROCESS_COUNT=$(BENCH_PROCESS_COUNT) BENCH_COORDINATOR_HISTORY=$(BENCH_COORDINATOR_HISTORY) .build/release/mactopBench
